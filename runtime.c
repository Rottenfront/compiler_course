...
#define SET_HEADER(type, name)                                                 \
  ...
  void iterate_##name(name *root, void *context, void (*func)(void *, type *))

#define MAP_HEADER(type, value_type, name)                                     \
  typedef struct name name;                                                    \
  struct name {                                                                \
    type key;                                                                  \
    value_type value;                                                          \
  ...
  void free_##name(name *p);                                                   \
  void insert_##name(name **root, type value, value_type value);               \
  void erase_##name(name **root, type value);                                  \
  void iterate_##name(name *root, void *context,                               \
                      void (*func)(void *, type *, value_type *))
SET_HEADER(size_t *, ptr_set);
...
#define SET_IMPL(type, name)                                                   \
  ...
  void iterate_##name(name *p, void *context, void (*func)(void *, type *)) {  \
    if (p == NULL)                                                             \
      return;                                                                  \
